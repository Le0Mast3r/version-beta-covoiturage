...
//If username exists in the drivers table print error
...
//If email exists in the drivers table print error
...
if($errors){
    ...
    //Insert user details and activation code in the drivers table
    $sql = "INSERT INTO drivers (`username`, `email`, `password`, `first_name`, `last_name`, `phonenumber`, `gender`, `moreinformation`) VALUES ('$username', '$email', '$password','$firstname', '$lastname', '$phonenumber', '$gender', '$moreinformation')";
    $result = mysqli_query($con, $sql);
