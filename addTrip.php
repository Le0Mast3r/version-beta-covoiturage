...
if($errors){
    ...
    $sql = "INSERT INTO trip (`user_id`,`departure`, `departureLat`,`departLong`,`destination`, `destinationLat`, `destLong`, `price`, `seatsavailable`,`date`, `time`,`comments`) VALUES ('".$_SESSION['user_id']."', '$from','$departLat','$departLong','$to','$destLat','$destLong','$price','$places','$date','$time','$desc')";   
